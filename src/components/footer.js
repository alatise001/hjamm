...
export default function Footer() {
    return (
        <div className='pt-10 pb-5 px-6 bg-white h-max flex flex-col gap-10 '>
            <div className='flex flex-col gap-6'>
                ...
                <p className='text-[#7A7A7A] text-[12px] font-switzer leading-4.25'>
            ...
            <div className='flex items-center justify-center flex-col text-left px-4 pt-6.5 gap-5.5'>
                <p className='text-[#7A7A7A] font-switzer text-[12px]'>
                    © 2026 Hearts of Jesus and Mary Ministry (HJAMM). All rights reserved.
                </p>

                <p className='text-[#7A7A7A] font-switzer text-[12px] underline '>
