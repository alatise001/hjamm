...
export default function EventBlock() {
    return (
        ...
        <div className=" h-fit rounded-[10px] border border-[#0000001A] bg-[#F5F1ED] shadow">
            <div className=" flex flex-col items-center gap-8 justify-center bg-[url('/missionBg.png')] px-6.5 rounded-t-[10px] bg-cover bg-center h-[216px] bg-blend-overlay bg-black/50" />

            <div className="px-6 py-6.5 flex flex-col gap-3 rounded-b-[10px] bg-[#F5F1ED]">

                <div className='flex items-center gap-2 text-[#8B3A3A] text-[10px] font-bold font-switzer'>
                    <Calendar className='h-3.5 w-3.5' />
                    <p>June 12 – 14, 2026</p>
                </div>

                <h2 className="text-[#2C2C2C] text-[24px] font-gambetta tracking-[-0.24px]">
                ...
                <p className='font-switzer inline-block text-[12px] font-light leading-[16.8px] text-[#6B7280]'>
                ...
                <div className='flex flex-col gap-1.5'>
                    <p className='text-[#6B7280] font-switzer font-bold uppercase tracking-[1px] text-[10px]'>Registration Fee</p>
                    ...
                    <Button className="h-12.5 w-full text-[14px] tracking-[1.4px] mt-[24px]">
                        Register Now
                    </Button>
