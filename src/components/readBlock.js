...
export default function ReadBlock({ title, author, price, img, link }) {
    return (

        <div className=" h-fit rounded-[10px] border border-[#0000001A] bg-white px-4.5 py-6 shadow">
            ...
            <div className='flex justify-between items-center'>
                ...
                <div className='bg-[#8B3A3A] h-[40px] w-[40px] hover:scale-105 rounded-[8px] flex items-center justify-center' >
                    <Link href={link} target="_blank" rel="noopener noreferrer">
                        <ShoppingCart className='text-white  h-[16px] w-[16px]' />
                    </Link>
                </div>
            </div>
