        ...
        <div className="min-w-68 lg:h-fit lg:w-fit h-fit rounded-[10px] border border-[#0000001A] shadow">
            <div className="relative outline-1 bg-[url('/heroBg.jpg')] rounded-[10px] bg-cover bg-center h-47.75" >
                <div className='absolute shadow top-4 right-3.25 bg-[#D4AF37E5] px-3 py-1 w-fit flex items-center justify-center'>
                    <p className='uppercase text-white text-[8px] lg:text-[10px] font-bold font-switzer tracking-[.8px]'>Workshop</p>
                </div>
            </div>
            ...
            <div className="p-4.5 lg:p-8 flex flex-col gap-2">
                <div className='text-[#8B3A3A99] flex gap-2 items-center'>
                    ...
                    <p className='font-bold font-switzer text-[8px] lg:text-[11px] uppercase tracking-[1px] '>YouTube & Facebook Live</p>
                </div>
