...
export default function Ministries() {
    return (
        <div>
            <section className="pt-36 pb-16 px-9.25 md:pt-50 h-[80vh] bg-[url('/ministriesBg.jpg')] bg-cover bg-center flex flex-col gap-8 items-center bg-blend-overlay bg-black/80">
                ...
                <div className="flex flex-col lg:max-w-[50%] gap-5">
                    <h1 className="text-[36px] md:text-[72px] text-white font-gambetta font-medium text-center tracking-[-2.4px]">A Communion of Heart</h1>

                    <p className="text-[#ffffff] italic text-[14px] md:text-[24px] font-light font-switzer text-center">
                        Discover the various ways we serve together as one body in Christ, bringing the healing presence of the Sacred Hearts to the world.
                    </p>
                </div>
            </section>
