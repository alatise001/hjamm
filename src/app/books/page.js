...
export default function Books() {
    return (
        <div>
            <section className="pt-36 pb-16 px-9.25 md:pt-50 h-[80vh] bg-[url('/booksBg.jpg')] bg-cover bg-center flex flex-col gap-8 items-center bg-blend-overlay bg-black/80">
                ...
                <div className="flex flex-col lg:max-w-[50%] gap-5">
                    <h1 className="text-[36px] md:text-[72px] text-white font-gambetta font-medium text-center tracking-[-2.4px]">Sacred Readings & Spiritual Growth</h1>
            ...
            <section className=" bg-[#F5F1ED] py-8 md:py-[70px] md:px-[36px] px-6 flex flex-col gap-7">
                <div className="text-center flex flex-col gap-4.5 w-[90%] mx-auto">
                    ...
                    <p className="text-[12px] md:text-[18px] font-switzer text-[#4A5565] leading-4.75 ">Find the Spiritual Wisdom you seek</p>
